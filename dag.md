...
| D20 | Def 20: product-regular lift (11 guards, canonical form Eq. S.2.67 p42; Eq 63 / S.2.26 p35) (p9; recalled p35, p42) | Sec II B machinery (S.2.16–S.2.22), Sec II B setup (S.2.16-S.2.22) | DEF | — | eleven guards: det E, det B(det B)#, det C(det C)#, c₆h, c₆v, δh, δv, Disc qh, Disc qv, Rh, Rv |
